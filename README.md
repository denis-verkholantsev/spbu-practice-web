...
Имеет статус, изначально - ```not approved```. При проверке преподаватель может сменить его на ```approved```, но обязательно оставить комментарий. Преподаватель может изменить комментарий в любой момент.
